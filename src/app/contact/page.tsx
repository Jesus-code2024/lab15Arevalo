...
export const metadata: Metadata = {
  title: 'Contacto',
  description: `Ponte en contacto con ${personalInfo.name}. Envíame un mensaje o conéctate a través de redes sociales.`,
  openGraph: {
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <p className="text-sm text-gray-500 mt-4 text-center">
            También puedes contactarme directamente por email a{' '}
            <a href={`mailto:${personalInfo.email}`} className="text-blue-600 hover:underline">
              {personalInfo.email}
            </a>
          </p>
